...
This repository contains the .pbix file for the dashboard. Screenshots of both pages are a good addition here before linking this from a resume, since GitHub does not render Power BI files inline.
